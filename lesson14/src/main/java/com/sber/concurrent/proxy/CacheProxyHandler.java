package com.sber.concurrent.proxy;
...
public class CacheProxyHandler implements InvocationHandler {
    ...
    private void serialize(Method method, Map<Object, Object> cache) {
        ...
        synchronized (lock) {
            try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(path))) {
                ...
                System.err.println("Объект не сериализуем");
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    private Map<Object, Object> deserialize(String fileName) {
        ...
        Map<Object, Object> cacheTmp = new ConcurrentHashMap<>();
        ...
        synchronized (lock) {
            try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(path))) {
                cacheTmp = (ConcurrentHashMap<Object, Object>) ois.readObject();
